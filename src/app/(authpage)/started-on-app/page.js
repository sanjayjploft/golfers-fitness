    ...
    <div className="signup-wrapper started-app-bg">
      ...
      <div className="signup-card">
        <h2 className="login-title">
          <img src="/images/almot-icon.png" className="me-1" alt="" /> You’re
          Almost Set!
        </h2>
        ...
        <div className="start_app_sec">
          <h5 className="fw-bold mb-3 mt-4">What you’ll unlock in the app:</h5>
          ...
          <p className="text-center text-muted mt-3 text-dark">
            You can always return to the web to view your dashboard, manage your
            plan, and track progress.
          </p>
          <Link
            href={"/dashboard"}
            className="get-started-btn w-100 w-100 mt-4">
